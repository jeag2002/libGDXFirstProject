...
public abstract class DynamicCollEnemiesObject extends CollisionEnemiesObject implements GameAnimationInterface{

	private SpriteObject sO;
	
	
	public DynamicCollEnemiesObject(World world, SpawnType spawnType) {

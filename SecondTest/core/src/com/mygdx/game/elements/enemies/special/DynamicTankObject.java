...
public abstract class DynamicTankObject extends CollisionTankObject implements GameAnimationInterface{

	private SpriteObject sO;
	
	
	public DynamicTankObject(World world, SpawnType spawnType) {
